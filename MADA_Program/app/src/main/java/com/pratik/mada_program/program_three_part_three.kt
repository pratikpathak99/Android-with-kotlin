...
class program_three_part_three : AppCompatActivity() {


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_program_three_part_three)
        supportActionBar?.hide()
    }

    fun saveRecord(view: View) {
        val u_id = findViewById(R.id.u_id) as EditText
        val u_name = findViewById(R.id.u_name) as EditText
        val u_email = findViewById(R.id.u_email) as EditText
